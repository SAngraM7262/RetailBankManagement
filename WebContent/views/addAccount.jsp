...
<title>National Bank | Add Account</title>
...
<div class="mdc-card mdc-elevation--z7" style="width: 50rem; padding : 20px; margin : 10px auto;">
	    ...
	    <div class="mdc-tab-scroller__scroll-area">
	      <div class="mdc-tab-scroller__scroll-content">
	        <button class="mdc-tab mdc-tab--active" role="tab" aria-selected="true" tabindex="0" disabled>
	          <span class="mdc-tab__content">
	            <span class="mdc-tab__text-label">Get The New Account Details</span>
	          </span>
	          <span class="mdc-tab-indicator mdc-tab-indicator--active">
	            <span class="mdc-tab-indicator__content mdc-tab-indicator__content--underline"></span>
	          </span>
	...
	<div class="row">
		<div class= "col-md">
			...
			<label for="customerId" class = "font-weight-bold text-secondary"><span class="text-danger">*</span> Customer Id :.</label>
			<select name = "custId" class="form-control" required>
				<c:forEach items = "${customerIdList}" var = "custId">
	...
	<div class="row">
		<div class= "col-md">
			<div class="form-group">
			    <label for="accountType" class = "font-weight-bold text-secondary"><span class="text-danger">*</span> Account Type :.</label>
	...
	<div class="row">
		<div class= "col-md">
			<div class="form-group">
			    <label for="depositAmmount" class = "font-weight-bold text-secondary"><span class="text-danger">*</span> Deposit :.</label>
			    <input type="number" class="form-control" id="deposit" name = "depositAmount" min = 1 max = 999999999 placeholder="Enter Initial Deposit Ammount" required>
			</div>
		</div>
	</div>
	  
	  
	  <button type="submit" class="mdc-button mdc-button--raised mdc-elevation--z4"><span class="mdc-button__label">Create Account</span></button>
