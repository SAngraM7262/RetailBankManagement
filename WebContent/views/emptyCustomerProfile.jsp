...
<title>National Bank | No Customer Found</title>
...
<div class = "container">
	<div class="mdc-card mdc-elevation--z7 d-flex align-items-center" style="width: 50rem; padding : 20px; margin : 10px auto;">
		...
		<div class = "row">
			...
			<span class = "text-secondary text-muted text-*-center font-weight-bold" style = "line-height: 20px;"> No Record Found With Given Customer</span>
