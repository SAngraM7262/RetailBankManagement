...
<title>National Bank | Delete Account</title>
...
<div class="mdc-card mdc-elevation--z7" style="width: 50rem; padding : 20px; margin : 10px auto;">
	    ...
	    <div class="mdc-tab-scroller__scroll-area">
	      <div class="mdc-tab-scroller__scroll-content">
	        <button class="mdc-tab mdc-tab--active" role="tab" aria-selected="true" tabindex="0" disabled>
	          <span class="mdc-tab__content">
	            <span class="mdc-tab__text-label">Delete Customer Account</span>
	          </span>
	          <span class="mdc-tab-indicator mdc-tab-indicator--active">
	            <span class="mdc-tab-indicator__content mdc-tab-indicator__content--underline"></span>
	          </span>
	...
	<form action = "${pageContext.request.contextPath}/CustomerAccountController?action=delete" method = "POST">
	  <div class="form-group">
			<label for="accountId" class = "font-weight-bold text-secondary"><span class="text-danger">*</span> Account Id :.</label>
			<select name = "accountId" class="form-control" required>
				<c:forEach items = "${accountIdList}" var = "accountId">
