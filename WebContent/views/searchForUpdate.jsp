...
<title>National Bank | Search Customer</title>
  ...
  <div class="mdc-tab-scroller">
    <div class="mdc-tab-scroller__scroll-area">
      <div class="mdc-tab-scroller__scroll-content">
        ...
        <button class="mdc-tab  mdc-tab--active" role="tab" onclick="window.location.href='${pageContext.request.contextPath}/views/deleteCustomer.jsp'" aria-selected="true" tabindex="0">
          <span class="mdc-tab__content">
...
<div class = "body">
	    ...
	    <div class="mdc-tab-scroller__scroll-area">
	      <div class="mdc-tab-scroller__scroll-content">
	        <button class="mdc-tab mdc-tab--active" role="tab" aria-selected="true" tabindex="0" disabled>
	          <span class="mdc-tab__content">
	            <span class="mdc-tab__text-label">Search Customer Details To Edit Details</span>
	          </span>
	          <span class="mdc-tab-indicator mdc-tab-indicator--active">
	            <span class="mdc-tab-indicator__content mdc-tab-indicator__content--underline"></span>
	          </span>
	...
	<form action = "${pageContext.request.contextPath}/CustomerProfileController?action=search" method = "POST">
	  ...
	  <div class="form-group">
	    <label for="customerSSNId" class = "font-weight-bold text-secondary">Customer SSNId :.</label>
	    <input type="number" class="form-control" id="custSSNId" name = "custSSNId" min="-1" max="999999999" placeholder="Enter customer SSNId">
	    <small id="emailHelp" class="form-text text-muted">Enter 9 digit customer SSNId</small>
	  </div>
	  <button type="submit" class="mdc-button mdc-button--raised mdc-elevation--z4"><span class="mdc-button__label">Search Customer</span></button>
	</form>
