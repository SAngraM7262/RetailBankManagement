...
<title>National Bank | Customer Page</title>
...
<div class="mdc-card mdc-elevation--z7" style="width: 50rem; padding : 100px 70px; margin : 50px auto;">
	<div class = "row">
		<div class = "col-md">
			  <button class="mdc-button mdc-button--raised mdc-elevation--z4"  onclick="window.location.href='${pageContext.request.contextPath}/CustomerStatusController'"><span class="mdc-button__label"> Manage Customer Information</span></button>
		</div>
		<div class = "col-md">
			  <button class="mdc-button mdc-button--raised mdc-elevation--z4"  onclick="window.location.href='${pageContext.request.contextPath}/AccountStatusController'"><span class="mdc-button__label"> Manage Account Details</span></button>
		</div>
	</div>
