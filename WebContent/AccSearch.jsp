...
<title>National Bank | Search Account</title>
...
<div class="mdc-card mdc-elevation--z7" style="width: 50rem; padding : 20px; margin : 10px auto;">
	    ...
	    <div class="mdc-tab-scroller__scroll-area">
	      <div class="mdc-tab-scroller__scroll-content">
	        <button class="mdc-tab mdc-tab--active" role="tab" aria-selected="true" tabindex="0" disabled>
	          <span class="mdc-tab__content">
	            <span class="mdc-tab__text-label">Find Account</span>
	          </span>
	          <span class="mdc-tab-indicator mdc-tab-indicator--active">
	            <span class="mdc-tab-indicator__content mdc-tab-indicator__content--underline"></span>
	          </span>
	...
	<form action = "${pageContext.request.contextPath}/CashierController" method = "POST">
	  <div class="form-group">
	    <label for="customerId" class = "font-weight-bold text-secondary">Customer Id :.</label>
	    <input type="number" class="form-control" id="custId" name = "custId" min="-1" max="999999999" onkeypress="return isNumberKey(event)" placeholder="Enter customer Id">
	  ...
	  <div class="form-group">
	    ...
	    <input type="number" class="form-control" id="accId" name = "accId" min="-1" max="999999999" onkeypress="return isNumberKey(event)" placeholder="Enter Account Id">
	    <small id="emailHelp" class="form-text text-muted">Enter 9 digit Account Id</small>
	  </div>
	  <button type="submit" value="VIEW" class="mdc-button mdc-button--raised mdc-elevation--z4"><span class="mdc-button__label">Search Account</span></button>
	</form>
